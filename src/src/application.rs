...
mod imp {
    ...
    impl ObjectSubclass for Application {
        const NAME: &'static str = "AxuralisApplication";
...
impl Default for Application {
    fn default() -> Self {
        glib::Object::builder::<Application>()
            ...
            .property("resource-base-path", "/com/axos-project/Axuralis")
            .build()
    }
}
...
impl Application {
    ...
    fn show_about(&self) {
        ...
        let dialog = adw::AboutDialog::builder()
            ...
            .application_name("Axuralis")
            .developer_name("Ardox")
            .version(VERSION)
            .developers(vec!["Ardox"])
            .copyright("© 2025 Ardox")
            .website("https://github.com/axos-project/Axuralis")
            .issue_url("https://github.com/axos-project/Axuralis/issues")
    ...
    async fn portal_request_background(&self) {
        if let Some(window) = self.active_window() {
            ...
            let request = Background::request().identifier(identifier).reason(&*i18n(
                "Axuralis needs to run in the background to play music",
            ));
